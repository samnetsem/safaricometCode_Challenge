...
(function($) {
    ...
    var password_Strength = new function() {
        ...
        this.getStrengthInfo = function(passwordVal) {
            ...
            (password_settings.minLength -
                password_settings.numberLength -
                password_settings.specialLength -
    ...
    $.fn.password_strength = function(options) {
        ...
        return this.each(function() {
            ...
            var passIndi =
                $('<div id="PasswordStrengthBorder"></div><div id="PasswordStrengthBar" class="BarIndicator"></div>')
